...
from .views import searchview,CategorySearch,ProductDetailView,Filtering,SearchBySize,AssignQuerytoSearch,SearchFilter
urlpatterns=[
    ...
    path('SearchFiltering',SearchFilter.as_view())
]